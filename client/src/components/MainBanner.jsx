  ...
  return (
    <div className='relative'>
      ...
      md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24'>
        ...
        Quality You Can Count On, Prices You'll Adore!</h1>
        <div className='flex items-center mt-6 font-medium'>
        <Link className='group flex items-center gap-2 px-7 md:px-9 py-3 bg-primary hover:bg-primary-dull
        transition rounded text-white cursor-pointer'>Shop now
        <img className='md:hidden transition group-focus:translate-x-1' src={assets.white_arrow_icon} alt='arrow' />
        </Link>
        <Link className='group hidden md:flex items-center gap-2 px-9 py-3 cursor-pointer'>See all Deals
        <img className='transition group-focus:hover-x-1' src={assets.black_arrow_icon} alt='arrow' />
        </Link>
      </div>
      </div>
